...
| 2 | **The Ferry That Never Left** | Harbor ↔ Ember | Badge 4 | Rossi's ferry pumps could drain the Drowned Stair, but they need Kettering's crew to run. Broker it. Main-story gate for the Undercity, but the *full* quest (restoring the ferry itself) is optional. | Gyaradosite; postgame the ferry runs |
...
- **Gym leaders** rematch postgame with full six-mon Mega teams. Cameruptite (Ashgrave) and Pinsirite (Thistle) are rematch rewards.
