...
| 8 | **Meridian Tower** | **Fully built** — [`districts/tower.md`](districts/tower.md) | Director Vance's HQ. Corporate, glass, sterile. Act 3's confrontation; the freight core down. | Steel, Psychic, Ground |
| 7 | **The Sprawl** | **Fully built** — [`districts/sprawl.md`](districts/sprawl.md) | Mid-city residential/commercial layer where Meridian is ordinary — landlord, employer, sponsor. No gym. Act 3's first stop: Dario's choice, Halloran's office. | Normal, Fairy, mixed |
